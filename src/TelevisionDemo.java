...
/**
    ...
    * It creates instances of the Television class, changes their state,
    * and prints the state to the console.
...
{
	/**
     * The main method to test the Television class.
     * 
